...
public class FrmCompilador extends JFrame {	
	...
	private String newline(Token t) {
		return String.valueOf(t.getPosition()) + "\t" + //TODO: n�o pode ser o position, tem que ser a linha 
			Classes.get(t.getId()) + "\t" + String.valueOf(t.getLexeme());
	}

	private void gerarCodigo() {
		imprimirMensagem("gera��o de c�digo ainda n�o foi implementada");
	}	
	...
	private void atualizaStatusBar(boolean modificado) {
		lblStatusbar.setText((nomeArquivo.isEmpty() ? "" : nomeArquivo + ": ") + (modificado ? "Modificado" : "N�o modificado"));		
	}	
